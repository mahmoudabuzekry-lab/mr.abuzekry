...
const TEMPLATE_TYPES_MAP: Record<string, string> = {
  ...
  'registration_approved': 'قبول واعتماد طلب التسجيل',
  'registration_rejected': 'اعتذار/رفض طلب التسجيل',
...
export default function WhatsAppSender({ templates, onRefresh }: WhatsAppSenderProps) {
  ...
  const handleResetToDefaults = () => {
    const INITIAL_TEMPLATES: WhatsAppTemplate[] = [
      ...
      {
        id: 't7',
        title: 'قبول واعتماد طلب التسجيل 🎉',
        type: 'registration_approved',
        text: 'ولي الأمر العزيز، يسعدنا إعلامكم بقبول واعتماد طلب تسجيل الطالب/الطالبة *[اسم_الطالب]* (الصف: *[الصف_الدراسي]*) في درس العلوم للأستاذ محمود أبوذكري بمجموعة *[اسم_المجموعة]*. كود الطالب الخاص به هو: *[الكود]*. يرجى الاحتفاظ بالكود لتسجيل الحضور وسداد الاشتراكات. أهلاً ومرحباً بكم معنا!'
      },
      {
        id: 't8',
        title: 'اعتذار/رفض طلب التسجيل ❌',
        type: 'registration_rejected',
        text: 'ولي الأمر العزيز، نعتذر منكم لعدم إمكانية قبول طلب تسجيل الطالب/الطالبة *[اسم_الطالب]* (الصف: *[الصف_الدراسي]*) في درس العلوم للأستاذ محمود أبوذكري حالياً بسبب: *[السبب]*. نسعد بخدمتكم في المناسبات القادمة. مع تحيات الأستاذ محمود أبوذكري.'
      }
    ];
